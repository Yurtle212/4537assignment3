...
function FilteredPagination({ types, checkedState, pokemon, setPokemon }) {
  ...
  return (
    <>
      < Page currentPokemons={currentPokemons} currentPage={currentPage} setPokemon={setPokemon} pokemon={pokemon} />
      < Pagination
